...
open class IOSDropDown : UITextField{
    ...
    @IBInspectable public var NborderColor: UIColor =  UIColor.lightGray {
        didSet {
            layer.borderColor = NborderColor.cgColor
        }
    }
    ...
    @IBInspectable public var NborderWidth: CGFloat = 0.0 {
        didSet {
            layer.borderWidth = borderWidth
        }
    }
    
    @IBInspectable public var NcornerRadius: CGFloat = 5.0 {
        didSet {
