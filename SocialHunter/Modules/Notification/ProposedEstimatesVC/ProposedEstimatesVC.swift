...
class ProposedEstimatesVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        pitch_tblvw.register(UINib(nibName: "PeopleCell", bundle: nil), forCellReuseIdentifier: "Cell")
...
extension ProposedEstimatesVC: UITableViewDelegate, UITableViewDataSource
{
